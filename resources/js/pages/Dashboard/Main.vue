...
const options = reactive({
    ...
    colors: ['#EE6F85', '#F3CA81', '#F38F81', '#9656FF', '#9A93BA'],
...
<template>
    <div class="box-border w-full py-10">
        ...
        <div class="w-full flex items-start flex-col lg:flex-row">
            <div class="w-full lg:w-1/2 lg:mr-5 mb-6">
                <div class="mb-8 w-full text-gray-200">
                    <div class="text-xl lg:text-5xl font-bold">Total Data</div>
                </div>
                <div class="w-full box-border grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div v-for="i in 4" :key="i" class="w-full h-32 bg-[#3B3955] rounded-[20px] box-border p-4 flex items-center">
                        ...
                        <div class="w-full flex-1">
                            <div class="mb-3 text-sm font-semibold text-gray-400">Total Liquidity</div>
                            <div class="font-semibold">Rp. 1.000.000</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 box-border bg-[#252237] p-10 rounded-3xl overflow-hidden relative h-72 lg:h-auto mb-10 lg:mb-0">
                <div class="absolute bg-[#2F2B43] rounded-full px-4 py-3 text-xs top-2 left-2 font-semibold">Data Rekam Medis</div>
                <!-- 252237 -->
